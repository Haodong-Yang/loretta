...
# MODEL=microsoft/deberta-v3-base TASK=COLA MODE=ft EPOCH=25 BS=32 LR=5e-4 DEVICE=0 bash finetune.sh
# MODEL=microsoft/deberta-v3-base TASK=SST2 MODE=ft EPOCH=24 BS=32 LR=8e-4 DEVICE=0 bash finetune.sh
# MODEL=microsoft/deberta-v3-base TASK=MRPC MODE=ft EPOCH=30 BS=32 LR=1e-3 DEVICE=0 bash finetune.sh
# MODEL=microsoft/deberta-v3-base TASK=STSB MODE=ft EPOCH=25 BS=32 LR=2.2e-3 DEVICE=0 bash finetune.sh
# MODEL=microsoft/deberta-v3-base TASK=QNLI MODE=ft EPOCH=5 BS=32 LR=1.2e-3 DEVICE=0 bash finetune.sh

# MODEL=microsoft/deberta-v3-base TASK=COLA MODE=newlora EPOCH=25 BS=32 LR=5e-4 DEVICE=0 bash finetune.sh
# MODEL=microsoft/deberta-base TASK=QNLI MODE=lora EPOCH=25 BS=32 LR=3e-4 DEVICE=0 bash finetune.sh

# MODEL=microsoft/deberta-v3-base TASK=QNLI MODE=lora EPOCH=5 BS=32 LR=1.2e-3 DEVICE=0 RANK=8 bash finetune.sh
...
MODEL=microsoft/deberta-v3-base TASK=RTE MODE=newlora EPOCH=50 BS=16 LR=1e-4 DEVICE=0 bash finetune.sh
